...
public class SecurityAlertServiceImpl implements SecurityAlertService {
    ...
    public void sendNewDeviceLoginAlert(String email, String ip, String userAgent) {
        ...
        String html = """
                ...
                <p>A new login to your BukaFresh account just occured.</p>
    ...
    public void SendEmailVerificationToNewUser(User savedUser, String token) {
        ...
        String verificationUrl = String.format("/api/users/verify-email?userId=%s&token=%s", userId, token);
    ...
    <body style="font-family:Arial, sans-serif; line-height:1.6;">
        ...
        <br/>
        <p>Kind regards,<br/>PaynoV8 Customer Success Team</p>
    </body>
    </html>
    """.formatted(verificationUrl);
        ...
        EmailDetails emailDetails = EmailDetails.builder()
                ...
                .subject("Verify your PaynoV8 Account")
